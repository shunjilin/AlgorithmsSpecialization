...
// recursive
unsigned
computeOptimalKnapsackValue(std::vector<Memoization::KnapsackObject> objects,
                            unsigned max_weight) {
...
int main()
{
    ...
    for (int trials = 0; trials < 1000; ++trials) {
        std::vector<Memoization::KnapsackObject> objects(n_weights_rng.generate());
        ...
        auto actual_optimal_value = Memoization::computeOptimalKnapsackValue(objects, max_weight);
